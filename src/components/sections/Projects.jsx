...
import capstone from '../icons/capstoneProject.png';
                ...
                <div className='max-w-5xl mx-auto px-4 flex flex-wrap gap-5'>
                    <div className="flex flex-col lg:flex-row p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59, 130, 246, 0.2)] transition">
                        ...
                        <div className="flex flex-col justify-between p-4 lg:w-1/2">
                            ...
                            <div className="flex flex-wrap gap-2 pt-1 pb-3">
                                {["React", "C#", "TypeScript", "PHP", "JavaScript", "Tailwind CSS"].map((item, index) => (
                            ...
                            <div className='p-2'>
                                View Project
                                <a href="https://categorify-frontend.vercel.app/" target="_blank" className='text-blue-400 hover:text-blue-300 transition-colors my-4'>
                    ...
                    <div className="flex flex-col lg:flex-row p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59, 130, 246, 0.2)] transition">
                        ...
                        <div className="flex flex-col justify-between p-4 lg:w-1/2">
                            ...
                            <div className="flex flex-wrap gap-2 pt-1 pb-3">
                                {["React", "Vite", "Tailwind CSS"].map((item, index) => (
                                    <span key={index} className="bg-blue-500/10 text-blue-500 px-3 py-1 rounded-full text-sm hover:bg-blue-500/20 hover:shadow-[0_2px_8px_rgba(59, 130, 246, 0.1)] transition-all">
                                        {item}
                                    </span>
                                ))}
                            ...
                            <div className='p-2'>
                                View Project
                                <a href="https://github.com/SamiNachwati/samidev-portfolio" target="_blank" className='text-blue-400 hover:text-blue-300 transition-colors my-4'>
                                    <FontAwesomeIcon icon={faUpRightFromSquare} className='ml-3'/>
                                </a>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col lg:flex-row p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59, 130, 246, 0.2)] transition">
                        ...
                        <div className="flex flex-col justify-between p-4 lg:w-1/2">
                            ...
                            <div className="flex flex-wrap gap-2 pt-1 pb-3">
                                {["React", "Vite", "Tailwind CSS", "Node.js", "SQLite", "Express.js"].map((item, index) => (
                                    <span key={index} className="bg-blue-500/10 text-blue-500 px-3 py-1 rounded-full text-sm hover:bg-blue-500/20 hover:shadow-[0_2px_8px_rgba(59, 130, 246, 0.1)] transition-all">
                                        {item}
                                    </span>
                                ))}
                    ...
                    <div className="flex flex-col lg:flex-row p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59, 130, 246, 0.2)] transition">
                        ...
                        <div className="flex flex-col justify-between p-4 lg:w-1/2">
                            ...
                            <div className="flex flex-wrap gap-2 pt-1 pb-3">
                                {["Python", "Matplotlib", "Streamlit"].map((item, index) => (
                                    <span key={index} className="bg-blue-500/10 text-blue-500 px-3 py-1 rounded-full text-sm hover:bg-blue-500/20 hover:shadow-[0_2px_8px_rgba(59, 130, 246, 0.1)] transition-all">
                                        {item}
                                    </span>
                                ))}
